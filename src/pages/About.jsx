...
export default function About() {
    ...
    const values = [
        ...
        },
        {
            icon: HandHeart,
            title: 'Устойчивост',
            text: 'Рециклируеми опаковки, компостиране на утайката от кафенетата ни и дългосрочни договори с производителите.',
        },
        {
            icon: Coffee,
            title: 'Общност',
            text: 'Кафенетата ни са място за срещи, дегустации и обучения. Вярваме, че доброто кафе събира хората.',
        },
    ];
        ...
        <div className="min-h-screen bg-white py-24 animate-in fade-in duration-700">
            <div className="max-w-[1100px] mx-auto px-6 md:px-12">
                ...
                <div className="prose-recoffee max-w-3xl mx-auto text-slate-600 font-light leading-relaxed space-y-6 text-lg mb-20">
                    ...
                    <p>
                        Днес печем всяка седмица в работилницата ни в София. Работим директно с ферми и малки
                        кооперативи, а всяка партида се профилира индивидуално — защото кафе от Хуила и кафе от
                        Сидамо не се пекат по един и същи начин. Каним те да усетиш разликата: в чаша при нас,
                        или у дома с нашите зърна.
                    </p>
                    <p>
